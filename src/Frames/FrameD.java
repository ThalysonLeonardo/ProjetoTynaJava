...
public class FrameD extends javax.swing.JFrame {
    ...
    public FrameD() {
        try {
            BufferedWriter writeFile = new BufferedWriter(new FileWriter("Condição 4.csv"));
    ...
    private void TentativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TentativaActionPerformed
        if(Play1.Aceso && Play2.Aceso && Play3.Aceso){
            ...
            try {
                FileWriter writeFile = new FileWriter("Condição 4.csv", true);
