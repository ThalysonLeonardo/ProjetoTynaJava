...
public class FrameB extends javax.swing.JFrame {
    ...
    public FrameB() {
        try {
            BufferedWriter writeFile = new BufferedWriter(new FileWriter("Condição 2.csv"));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("VOCÊS GANHARAM");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setText("+60 PONTOS");
        ...
        jLabel1.setText("Pontos do Grupo:");
    ...
    private void TentativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TentativaActionPerformed
        if(Play1.Aceso && Play2.Aceso && Play3.Aceso){
            ...
            try {
                FileWriter writeFile = new FileWriter("Condição 2.csv", true);
