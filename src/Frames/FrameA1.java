...
public class FrameA1 extends javax.swing.JFrame {
    ...
    public FrameA1() {    
        try {
            BufferedWriter writeFile = new BufferedWriter(new FileWriter("Condição 14.csv"));
        ...
        setExtendedState(FrameA1.MAXIMIZED_BOTH);
        initComponents();
    }
    ...
    private void TentativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TentativaActionPerformed
        if(Play1.Aceso && Play2.Aceso && Play3.Aceso){
            ...
            try {
                FileWriter writeFile = new FileWriter("Condição 14.csv", true);
