...
public class FrameE1 extends javax.swing.JFrame {
    ...
    public FrameE1() {
        try {
            BufferedWriter writeFile = new BufferedWriter(new FileWriter("Condição 10.csv"));
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Pontos do Grupo:");
    ...
    private void TentativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TentativaActionPerformed
        if(Play1.Aceso && Play2.Aceso && Play3.Aceso){
            ...
            try {
                FileWriter writeFile = new FileWriter("Condição 10.csv", true);
